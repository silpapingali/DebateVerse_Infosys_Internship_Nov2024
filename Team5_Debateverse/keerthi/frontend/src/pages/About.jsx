...
const About = () => {
  ...
  return (
    <div className="pt-16 flex flex-col min-h-screen items-center justify-center bg-emerald-400">
      <div className="max-w-5xl w-full">
        <h1 className="text-3xl font-bold mb-8 text-center text-black">About DebateHub</h1>
        ...
        <div className="flex flex-wrap ">
          <div className="flex-1 bg-white p-6 rounded shadow-md">
            <h2 className="text-xl font-bold mb-2 text-black">Join the Community</h2>
            <p className="text-base text-gray-700">
            ...
            <div className="text-center">
              <button
                ...
                className="mt-6 px-6 py-3 text-base font-medium text-black bg-emerald-400"
              >
                Get Started
              </button>
            </div>
